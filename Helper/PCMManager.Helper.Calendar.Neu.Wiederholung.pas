...
{           ExpressScheduler                                         }
{                                                                    }
{           Copyright (c) 2003-2022 Developer Express Inc.           }
{           ALL RIGHTS RESERVED                                      }
{                                                                    }
...
unit PCMManager.Helper.Calendar.Neu.Wiederholung;
...
{$ENDIF}
  ...
  cxClasses, dxLayoutControl, dxSkinsCore, dxSkinBasic, dxSkinBlack, dxSkinBlue,
...
uses
  Variants, DateUtils, cxSchedulerStrs, cxFormats, cxSchedulerDialogs, dxMessageDialog,
...
procedure TcxSchedulerRecurrenceEventEditorForm.SelectPeriodicityClick(Sender: TObject);
begin
  if Locked then Exit;
...
function TcxSchedulerRecurrenceEventEditorForm.GetHelperClass:TcxSchedulerEditorHelperClass;
begin
...
procedure TcxSchedulerRecurrenceEventEditorForm.SaveEvent(AEvent: TcxSchedulerControlEvent);
begin
  if AEvent <> Event then
    AEvent.Assign(Event);
  SaveRecurrenceInfo(AEvent.RecurrenceInfo);
end;
procedure TcxSchedulerRecurrenceEventEditorForm.SaveRecurrenceInfo(AInfo: TcxSchedulerEventRecurrenceInfo);
var
...
procedure TcxSchedulerRecurrenceEventEditorForm.SaveDailyParams(AInfo: TcxSchedulerEventRecurrenceInfo);
begin
...
procedure TcxSchedulerRecurrenceEventEditorForm.SaveWeeklyParams(AInfo: TcxSchedulerEventRecurrenceInfo);
...
procedure TcxSchedulerRecurrenceEventEditorForm.SaveMonthlyParams(AInfo: TcxSchedulerEventRecurrenceInfo);
begin
...
procedure TcxSchedulerRecurrenceEventEditorForm.SaveYearlyParams(AInfo: TcxSchedulerEventRecurrenceInfo);
begin
...
//  lbOccurrences.Caption := cxGetResourceStr#ing(@scxOccurences);
  // buttons
...
procedure TcxSchedulerRecurrenceEventEditorForm.FormClose(Sender: TObject;var Action: TCloseAction);
begin
...
procedure TcxSchedulerRecurrenceEventEditorForm.SetActivePattern(Value: TcxRecurrence);
begin
  UpdateRange;
  Modified := True;
end;
...
procedure TcxSchedulerRecurrenceEventEditorForm.SetDateWithoutChangeEvent(AEdit: TcxDateEdit; ADate: TDateTime);
var
...
procedure TcxSchedulerRecurrenceEventEditorForm.SetItemIndexWithoutChangeEvent(AEdit: TcxComboBox; AIndex: Integer);
var
...
procedure TcxSchedulerRecurrenceEventEditorForm.SetTextWithoutChangeEvent(AEdit: TcxCustomMaskEdit; const AText: string);
var
  AOnChange, AOnEditValueChanged: TNotifyEvent;
...
procedure TcxSchedulerRecurrenceEventEditorForm.SetTimeWithoutChangeEvent(AEdit: TcxTimeEdit; ATime: TDateTime);
var
  AOnChange, AOnEditValueChanged: TNotifyEvent;
  AOnValidate: TcxEditValidateEvent;
begin
...
procedure TcxSchedulerRecurrenceEventEditorForm.meEndAfterPropertiesChange(Sender: TObject);
begin
  rbEndAfter.Checked := True;
  Modified := True;
end;
procedure TcxSchedulerRecurrenceEventEditorForm.deEndByPropertiesChange(Sender: TObject);
begin
  rbEndBy.Checked := True;
  Modified := True;
end;
procedure TcxSchedulerRecurrenceEventEditorForm.rbNoEndDateClick(Sender: TObject);
begin
  SetTextWithoutChangeEvent(meEndAfter, '10');
  SetEndDate;
  Modified := True;
end;
procedure TcxSchedulerRecurrenceEventEditorForm.meEndAfterExit(Sender: TObject);
begin
  ValidateNumber(Sender);
  SetEndDate;
end;
procedure TcxSchedulerRecurrenceEventEditorForm.ValidateNumber(Sender: TObject);
begin
...
procedure TcxSchedulerRecurrenceEventEditorForm.meDayPropertiesChange(Sender: TObject);
begin
  rbEvery.Checked := True;
  Modified := True;
end;
procedure TcxSchedulerRecurrenceEventEditorForm.rbEveryWeekdayClick(Sender: TObject);
begin
  SetTextWithoutChangeEvent(meDay, '1');
  Modified := True;
end;
procedure TcxSchedulerRecurrenceEventEditorForm.SetDayRadioButtonChecked(Sender: TObject);
begin
  rbDay.Checked := True;
  Modified := True;
end;
procedure TcxSchedulerRecurrenceEventEditorForm.SetTheRadioButtonChecked(Sender: TObject);
begin
  rbThe.Checked := True;
  Modified := True;
end;
procedure TcxSchedulerRecurrenceEventEditorForm.deStartPropertiesEditValueChanged(Sender: TObject);
begin
  UpdateRange;
end;
...
procedure TcxSchedulerRecurrenceEventEditorForm.cbMonthsPropertiesChange(Sender: TObject);
begin
  rbEvery1.Checked := True;
  Modified := True;
end;
procedure TcxSchedulerRecurrenceEventEditorForm.cbWeek1PropertiesChange(Sender: TObject);
begin
  rbThe1.Checked := True;
  Modified := True;
end;
...
procedure TcxSchedulerRecurrenceEventEditorForm.meEndAfterPropertiesEditValueChanged(Sender: TObject);
begin
  if Locked then Exit;
  SetEndDate;
end;
procedure TcxSchedulerRecurrenceEventEditorForm.cbDurationPropertiesPopup(Sender: TObject);
var
  AMinutes: Integer;
  AText: string;
begin
...
procedure TcxSchedulerRecurrenceEventEditorForm.cbDurationPropertiesValidate(Sender: TObject; var DisplayValue: Variant; var ErrorText: TCaption;var Error: Boolean);
var
  AMinutes: Integer;
begin
...
procedure TcxSchedulerRecurrenceEventEditorForm.EndTimeChanged(Sender: TObject);
begin
  UpdateDuration;
end;
procedure TcxSchedulerRecurrenceEventEditorForm.StartTimeChanged(Sender: TObject);
begin
