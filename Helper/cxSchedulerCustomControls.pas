...
uses
  System.UITypes,
  System.Classes, System.SysUtils, Winapi.Windows, Winapi.Messages, Vcl.Forms, Vcl.StdCtrls, Vcl.Controls, Vcl.Graphics, Vcl.ImgList,
  System.Types, System.Math, Vcl.ExtCtrls, Vcl.Menus, Vcl.Clipbrd, System.Generics.Collections, Winapi.MultiMon,
  ...
  cxDateUtils, cxStorage, cxTextEdit, cxNavigator, cxVariants, dxUxTheme, dxTouch, System.Contnrs,
...
type
  ...
  protected
    FBounds: TRect;
    FEventCellLayoutCalculateLockCount: Integer;
    ...
    function IsEventCellLayoutCalculatingLocked: Boolean;
 ...
 { TcxSchedulerNavigatorButton }
  ...
  protected
    ...
    procedure UpdateViewData; virtual;
    //
  ...
  private
    ...
    function GetDateTimeHelperClass: TcxSchedulerDateTimeHelperClass; inline;
  ...
  protected
    ...
    function IsWorkTime(AResourceItem: TcxSchedulerStorageResourceItem; const ADateTime: TDateTime): Boolean; inline;
  ...
  private
    ...
    function GetNavigatorTimer: TcxTimer;
    function GetScheduler: TcxCustomScheduler;
    function GetView: TcxSchedulerCustomView;
  ...
  protected
    ...
    property NavigatorTimer: TcxTimer read GetNavigatorTimer;
    property View: TcxSchedulerCustomView read GetView;
  public
  ...
  protected
    ...
    function GetEditStyleViewParams(AEvent: TcxSchedulerControlEvent): TcxViewParams; virtual;
    ...
    function GetLastAvailableDate: TDateTime; virtual;
    ...
    procedure InitEventBySelectedTime(AEvent: TcxSchedulerEvent; AllDay, ARecurrence, AInplaceEditing: Boolean); virtual;
    function InternalMouseWheel(Shift: TShiftState; WheelDelta: Integer; MousePos: TPoint): Boolean; virtual;
    function IsAllDaySelection: Boolean; virtual;
    ...
    procedure LockEventLayoutCalculating;
    procedure UnlockEventLayoutCalculating;
    ...
    procedure ScrollSelectedDays(AForward: Boolean; ANeedDate: TDateTime; AIsByPage: Boolean); overload; virtual;
  ...
  protected
    ...
    function GetCurrentDate: TDateTime; virtual;
  ...
  TcxSchedulerOnGetContentStyleEvent = procedure(Sender: TObject;
    AResource: TcxSchedulerStorageResourceItem; const ADateTime: TDateTime; var AStyle: TcxStyle) of object;
  ...
  private
    FCachedDefaultParams: TDictionary<Integer, TcxViewParams>;
    FCachedDataDefaultParams: TObjectDictionary<Integer, TDictionary<Integer, TcxViewParams>>;
    FScheduler: TcxCustomScheduler;
    ...
    procedure AddCachedDefaultViewParams(Index: Integer; AData: TObject; const AParams: TcxViewParams);
    function CanCacheViewParams(Index: Integer; AData: TObject): Boolean;
    procedure ClearCache(AIndex: Integer); overload;
    function GetCachedDefaultViewParams(Index: Integer; AData: TObject; out AParams: TcxViewParams): Boolean;
    function GetCachedDefaultViewParamsDataIndex(Index: Integer; AData: TObject): Integer; inline;
    function GetPainter: TcxCustomLookAndFeelPainter; inline;
    function GetPainterHelperClass: TcxSchedulerPainterHelperClass; inline;
    function GetResources: TcxSchedulerStorageResourceItems; inline;
    function GetSchedulerViewStyle: TcxSchedulerViewStyle; inline;
  protected
  ...
  protected
    ...
    procedure DoEventSelectionChanged(AEvent: TcxSchedulerControlEvent); virtual;
  ...
  protected
    ...
    procedure CreateNewEventItems(ANew, AllDay, ARecurrence: Boolean;
...
uses
  System.DateUtils, System.Variants, System.RTLConsts, cxSchedulerEditorFormManager,
  ...
  cxSchedulerEventModernInfoContainer, cxSchedulerCustomResourceView, dxDPIAwareUtils, dxMessageDialog;
...
type
  ...
  TcxSchedulerResourceViewInfoAccess = class(TcxSchedulerCustomResourceViewViewInfo);
...
constructor TcxSchedulerSubControl.Create(AOwner: TcxCustomScheduler);
begin
  inherited Create;
  FScheduler := AOwner;
  FVisible := True;
...
procedure TcxSchedulerSubControl.InvalidateRect(const ARect: TRect);
begin
...
procedure TcxSchedulerSubControl.SetBounds(ALeft, ATop, AWidth, AHeight: Integer);
begin
...
procedure TcxSchedulerSubControl.GetPropertyValue(const AName: string; var AValue: Variant);
begin
end;

procedure TcxSchedulerSubControl.SetPropertyValue(const AName: string; const AValue: Variant);
begin
end;

function TcxSchedulerSubControl.AllowDesignHitTest(X, Y: Integer; AShift: TShiftState): Boolean;
begin
...
function TcxSchedulerSubControl.CanCapture(const APoint: TPoint): Boolean;
begin
...
procedure TcxSchedulerSubControl.DoBeforeMouseDown(AButton: TMouseButton; AShift: TShiftState; X, Y: Integer);
begin
  MousePositionChanged(X, Y);
...
procedure TcxSchedulerSubControl.DoCreateScrollBars;
begin
end;

procedure TcxSchedulerSubControl.DoDestroyScrollBars;
begin
end;
...
procedure TcxSchedulerSubControl.DoMouseDown(AButton: TMouseButton; AShift: TShiftState; X, Y: Integer);
begin
  MousePositionChanged(X, Y);
  Controller.MouseDown(AButton, AShift, X, Y);
end;

procedure TcxSchedulerSubControl.DoMouseMove(AShift: TShiftState; X, Y: Integer);
begin
  MousePositionChanged(X, Y);
  Controller.MouseMove(AShift, X, Y);
end;

procedure TcxSchedulerSubControl.DoMouseUp(AButton: TMouseButton; AShift: TShiftState; X, Y: Integer);
begin
  MousePositionChanged(X, Y);
...
procedure TcxSchedulerSubControl.MousePositionChanged(var X, Y: Integer);
begin
  Dec(X, FLeft);
  Dec(Y, FTop);
...
procedure TcxSchedulerSubControl.Notification(AComponent: TComponent; Operation: TOperation);
begin
end;
...
procedure TcxSchedulerSubControl.UnInitScrollbars;
begin
end;

procedure TcxSchedulerSubControl.VisibleChanged;
begin
  ViewInfo.FEventCellLayoutCalculateLockCount := 0;
  Scheduler.AlignSubControls(Self);
  Changed;
end;
...
procedure TcxSchedulerSubControl.InitScrollBars;
begin
end;
...
procedure TcxSchedulerSubControl.SetVisible(AValue: Boolean);
begin
...
constructor TcxSchedulerSubControlController.Create(AOwner: TcxSchedulerSubControl);
begin
  FOwner := AOwner;
end;
...
function TcxSchedulerSubControlController.CanDrag(X, Y: Integer): Boolean;
begin
  Result := False;
end;

procedure TcxSchedulerSubControlController.DragAndDrop(const P: TPoint; var Accepted: Boolean);
begin
end;

procedure TcxSchedulerSubControlController.DragDrop(Source: TObject; X, Y: Integer);
begin
end;
...
procedure TcxSchedulerSubControlController.EndDrag(Target: TObject; X, Y: Integer);
begin
end;

procedure TcxSchedulerSubControlController.EndDragAndDrop(Accepted: Boolean);
begin
end;
...
procedure TcxSchedulerSubControlController.StartDrag(var DragObject: TDragObject);
begin
end;

function TcxSchedulerSubControlController.StartDragAndDrop(const P: TPoint): Boolean;
begin
  Result := False;
end;

procedure TcxSchedulerSubControlController.BeforeMouseDown(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
function TcxSchedulerSubControlController.GetCursor(X, Y: Integer): TCursor;
begin
  Result := Owner.Cursor;
end;

procedure TcxSchedulerSubControlController.KeyDown(var Key: Word; Shift: TShiftState);
begin
end;

procedure TcxSchedulerSubControlController.KeyPress(var Key: Char);
begin
end;

procedure TcxSchedulerSubControlController.KeyUp(var Key: Word; Shift: TShiftState);
begin
end;
...
procedure TcxSchedulerSubControlController.MouseDown(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
end;

procedure TcxSchedulerSubControlController.MouseMove(Shift: TShiftState; X, Y: Integer);
begin
end;

procedure TcxSchedulerSubControlController.MouseUp(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
constructor TcxSchedulerSubControlHitTest.Create(AOwner: TcxSchedulerSubControl);
begin
  inherited Create;
  FOwner := AOwner;
end;
...
function TcxSchedulerSubControlHitTest.GetBitState(AIndex: Integer): Boolean;
begin
  Result := (Flags and (1 shl AIndex)) <> 0
end;

function TcxSchedulerSubControlHitTest.GetMaskState(AMask: Integer): Boolean;
begin
  Result := Flags and AMask = AMask;
end;

function TcxSchedulerSubControlHitTest.GetMaskStateEx(AMask: Integer): Boolean;
begin
  Result := Flags and AMask <> 0;
end;

procedure TcxSchedulerSubControlHitTest.SetBitState(AIndex: Integer; AValue: Boolean);
begin
  if AValue then
...
procedure TcxSchedulerSubControlHitTest.SetMaskState(AMask: Integer; AValue: Boolean);
begin
  if AValue then
...
function TcxSchedulerSubControlHitTest.GetPosValue(AIndex: Integer): Integer;
begin
...
procedure TcxSchedulerSubControlHitTest.SetHitPoint(const APoint: TPoint);
begin
  FHitPoint := APoint;
  Recalculate;
end;

procedure TcxSchedulerSubControlHitTest.SetPosValue(AIndex, AValue: Integer);
begin
...
constructor TcxSchedulerSubControlPainter.Create(AOwner: TcxSchedulerSubControl);
begin
  FOwner := AOwner;
end;
...
constructor TcxSchedulerSubControlViewInfo.Create(AOwner: TcxSchedulerSubControl);
begin
  FOwner := AOwner;
end;
...
begin
  ...
  FUseRightToLeftAlignment := GetUseRightToLeftAlignment;
  FBounds := GetBounds;
  Clear;
  DoCalculate;
  AfterCalculate;
...
function TcxSchedulerSubControlViewInfo.GetUseRightToLeftAlignment: Boolean;
begin
  Result := Owner.UseRightToLeftAlignment;
end;

function TcxSchedulerSubControlViewInfo.IsEventCellLayoutCalculatingLocked: Boolean;
begin
  Result := FEventCellLayoutCalculateLockCount > 0;
end;
...
function TcxDragHelper.CanUpdateEventState(AEvent: TcxSchedulerControlEvent): Boolean;
begin
...
procedure TcxSchedulerDragObject.DropToDateNavigator(ADateNavigator: TcxSchedulerCustomDateNavigator);
begin
...
procedure TcxSchedulerDragObject.Finished(Target: TObject; X, Y: Integer; Accepted: Boolean);
begin
...
begin
  ...
  try
    ...
    dxMessageBox(Scheduler.Handle, AMessage, '', MB_ICONEXCLAMATION or MB_OK);
  finally
    AEvent.Free;
  end;
end;
...
procedure TcxDragEventHelper.ProcessDateNavigator(ADateNavigator: TcxSchedulerCustomDateNavigator);
begin
  try
    UpdateDateNavigatorClones(ADateNavigator);
    ValidateDestinationTime;
...
procedure TcxDragEventHelper.UpdateDateNavigatorClones(ADateNavigator: TcxSchedulerCustomDateNavigator);
var
  ADelta: TDateTime;
  I: Integer;
begin
...
constructor TcxSchedulerEventOperations.Create(AOwner: TcxCustomScheduler);
begin
  FScheduler := AOwner;
  FCreating := True;
  FDeleting := True;
...
begin
  ...
  TcxSchedulerModernStyleHintForm(FModernHint).OnClosed := OnModernStyleHintHide;
end;
...
begin
  ...
  if (FModernHint as TcxSchedulerModernStyleHintForm).Visible then
    TcxSchedulerModernStyleHintForm(FModernHint).Close;
  FreeAndNil(FModernHint);
  inherited Destroy;
end;
...
function TcxSchedulerHintController.CalcHintRect(AMaxWidth: Integer; const AHintText: string; AFlags: Integer): TRect;
begin
  CheckHintClass;
  FHintFlags := AFlags;
...
procedure TcxSchedulerHintController.ShowHint;
  ...
  begin
    ...
    AContainer.Scaled := False; // after ScaleForPPI
    AContainer.Initialize(AEventCell, FModernHintInfo);

    R := AEventCell.Bounds;
    R.Left := Min(R.Left, AEventCell.TimeLineRect.Left);
    ...
    AModernHint.CalloutVisible := True;

    AScreenRect := cxRectOffset(R, Scheduler.ClientToScreen(cxNullPoint));
    AWorkAreaRect := GetDesktopWorkArea(AScreenRect);

    if AIsTooLong or
      (AScreenRect.Left - AModernHint.PopupControl.Width < AWorkAreaRect.Left) and
      (AScreenRect.Right + AModernHint.PopupControl.Width > AWorkAreaRect.Right) then
    begin
    ...
    begin
      ...
      begin
        ...
        if FHintFlags and cxAlignBottom = cxAlignBottom then
          FHintRect := cxRectSetTop(FHintRect, Y + cxGetCursorSize.Height);
      end;
    end;
    if FHintWindow.UseRightToLeftAlignment then
      FHintRect.Offset(-FHintRect.Width, 0);
...
procedure TcxSchedulerClipboardController.InsertEvents(AEvents: TcxSchedulerFilteredEventList; Anchor: TDateTime);
var
  I: Integer;
  AEvent: TcxSchedulerControlEvent;
...
function TcxSchedulerClipboardController.KeyDown(var AKey: Word; AShift: TShiftState): Boolean;
begin
  Result := False;
  case AKey of
    VK_INSERT:
...
begin
  Result := dxCharInSet(AKey, [dxVKCopy, dxVKCut, dxVKPaste]);
  if Result then
  begin
    case AKey of
      dxVKCopy:
...
procedure TcxSchedulerClipboardController.RestoreEvent(var AEvent: TcxSchedulerControlEvent);
...
procedure TcxSchedulerClipboardController.SaveEvent(AEvent: TcxSchedulerControlEvent);
var
  I, APos: Integer;
begin
...
begin
  ...
  try
    EmptyClipboard;
    if SetClipboardData(CF_SCHEDULERDATA, dxStreamToHGlobal(Stream)) = 0 then
      RaiseLastOSError;
  finally
    Clipboard.Close;
  end;
...
begin
  CF_SCHEDULERDATA := Winapi.Windows.RegisterClipboardFormat(SCF_SCHEDULERCLIPBOARDFORMAT);
end;

{ TcxSchedulerPopupMenu }

constructor TcxSchedulerPopupMenu.Create(AScheduler: TcxCustomScheduler);
begin
  inherited Create;
  FScheduler := AScheduler;
    ...
    begin
      if not UseBuiltInPopupMenu then
        ...
        begin
          ...
          try
            AAdapter.SetLookAndFeel(Scheduler.LookAndFeel);
...
constructor TcxSchedulerCustomContentPopupMenu.Create(AScheduler: TcxCustomScheduler);
begin
...
procedure TcxSchedulerCustomContentPopupMenu.CreateNewEventItems(ANew,
  AllDay, ARecurrence: Boolean; ANewID, AllDayID, ARecurrenceID: Integer);
var
  AEnabled: Boolean;
begin
  ...
  if ANew then
  begin
    CreateSubItem(Root, cxGetResourceString(@scxpmNewEvent), ANewID, 2, AEnabled);
    FNewID := ANewID;
  end;
  if AllDay then
  begin
    CreateSubItem(Root, cxGetResourceString(@scxpmNewAllDayEvent), AllDayID, -1, AEnabled);
    FAllDayID := AllDayID;
  end;
  if Scheduler.StorageActive and Storage.IsRecurrenceAvailable and
    ARecurrence and Scheduler.EventOperations.Recurrence then
  begin
    CreateSubItem(Root, cxGetResourceString(@scxpmNewRecurringEvent), ARecurrenceID, 3, AEnabled);
...
begin
  if ACommand <> -1 then
    if ACommand = FNewID then
      ...
      if ACommand = FAllDayID then
        Scheduler.CreateEventUsingDialog(True)
      else
        if ACommand = FRecurrenceID then
          Scheduler.CreateEventUsingDialog(False, True);
end;

{ TcxSchedulerContentPopupMenu }

constructor TcxSchedulerContentPopupMenu.Create(AScheduler: TcxCustomScheduler);
begin
  inherited Create(AScheduler);
...
procedure TcxSchedulerContentPopupMenu.Execute(AItem: TcxSchedulerContentPopupMenuItem);
begin
  ExecuteCommand(Ord(AItem));
end;

function TcxSchedulerContentPopupMenu.GetMenuItem(AItem: TcxSchedulerContentPopupMenuItem): TMenuItem;
begin
...
function TcxSchedulerContentPopupMenu.IsValidCommand(ACommand: Integer): Boolean;
begin
...
constructor TcxSchedulerEventPopupMenu.Create(AScheduler: TcxCustomScheduler);
begin
  inherited Create(AScheduler);
...
constructor TcxSchedulerCustomDateNavigator.Create(AOwner: TcxCustomScheduler);
begin
  inherited Create(AOwner);
...
function TcxSchedulerCustomDateNavigator.GetCurrentDate: TDateTime;
begin
...
procedure TcxCustomScheduler.CreateEventUsingDialog(AllDay: Boolean = False; ARecurrence: Boolean = False);
var
  AEvent: TcxSchedulerControlEvent;
  AModified: Boolean;
begin
...
procedure TcxCustomScheduler.DeleteSelectedEvents(ACheckReadOnly: Boolean = True);
begin
...
procedure TcxCustomScheduler.EditEventUsingInplaceEdit(AEvent: TcxSchedulerControlEvent);
begin
...
procedure TcxCustomScheduler.DragDrop(Source: TObject; X, Y: Integer);
begin
...
function TcxCustomScheduler.GoToDate(ADate: TDateTime; AViewMode: TcxSchedulerViewMode): Boolean;
begin
...
begin
  ...
  if IsLocked or IsLoading or not HandleAllocated then
  begin
...
procedure TcxCustomScheduler.SelectEvent(AEvent: TcxSchedulerControlEvent; AShift: TShiftState = []);
begin
  EventList.Selection.Add(AEvent, AShift);
  if not IsLocked then
  begin
    CurrentView.LockEventLayoutCalculating;
    CurrentView.Refresh;
    CurrentView.UnlockEventLayoutCalculating;
  end;
end;
...
procedure TcxCustomScheduler.RestoreFromIniFile(const AStorageName: string; ARestoreResources: Boolean = True);
var
  AStorage: TcxStorage;
begin
...
procedure TcxCustomScheduler.RestoreFromRegistry(const AStorageName: string; ARestoreResources: Boolean = True);
var
  AStorage: TcxStorage;
begin
  AStorage := TcxStorage.Create(AStorageName);
...
procedure TcxCustomScheduler.RestoreFromStream(AStream: TStream; ARestoreResources: Boolean = True);
var
  AStorage: TcxStorage;
begin
...
procedure TcxCustomScheduler.StoreToStream(AStream: TStream; AStoreResources: Boolean = True);
var
  AStorage: TcxStorage;
begin
  AStorage := TcxStorage.Create(AStream);
...
procedure TcxCustomScheduler.GetChildren(Proc: TGetChildProc; Root: TComponent);
begin
...
procedure TcxCustomScheduler.Notification(AComponent: TComponent; Operation: TOperation);
var
  I: Integer;
begin
...
procedure TcxCustomScheduler.AddListener(AListener: IcxExternalDateNavigatorListener);
begin
...
procedure TcxCustomScheduler.RemoveListener(AListener: IcxExternalDateNavigatorListener);
begin
...
procedure TcxCustomScheduler.AlignSubControls(Sender: TcxSchedulerSubControl = nil);
begin
...
function TcxCustomScheduler.CreateSplitter(AKind: TcxSchedulerSplitterKind): TcxSchedulerSplitter;
begin
...
procedure TcxCustomScheduler.DoAfterDragEvent(Target: TObject; X, Y: Integer; var Accept: Boolean);
begin
...
procedure TcxCustomScheduler.DoAfterSizingEvent(AEvent: TcxSchedulerControlEvent; X, Y: Integer; var Accept: Boolean);
begin
  if Assigned(FOnAfterSizingEvent) then
    FOnAfterSizingEvent(Self, AEvent, X, Y, Accept);
end;

function TcxCustomScheduler.DoBeforeDeleting(AEvent: TcxSchedulerControlEvent): Boolean;
begin
  Result := True;
...
function TcxCustomScheduler.DoBeforeDragEvent(AEvent: TcxSchedulerControlEvent; X, Y: Integer): Boolean;
begin
  Result := True;
...
function TcxCustomScheduler.DoBeforeEditing(AEvent: TcxSchedulerControlEvent; AInplace: Boolean): Boolean;
begin
...
function TcxCustomScheduler.DoBeforeSizingEvent(AEvent: TcxSchedulerControlEvent; X, Y: Integer): Boolean;
begin
  Result := True;
...
procedure TcxCustomScheduler.DoCalculateLayout(AControl: TcxSchedulerSubControl);
begin
...
procedure TcxCustomScheduler.DoControllerReset(AControl: TcxSchedulerSubControl);
begin
  AControl.Controller.Reset;
end;

procedure TcxCustomScheduler.DoCreateEventUsingInplaceEdit(AKey: Char = #0);
var
...
begin
  ...
  for I := 0 to FSubControls.Count - 1 do
    SubControls[I].DoCreateScrollBars;
end;
...
begin
  ...
  for I := 0 to FSubControls.Count - 1 do
    SubControls[I].DoDestroyScrollBars;
end;

procedure TcxCustomScheduler.DoEventSelectionChanged(AEvent: TcxSchedulerControlEvent);
begin
...
var
  I: Integer;
  ACheckEventsCache: Boolean;
begin
  ACheckEventsCache := (CurrentView <> nil) and (Storage <> nil) and (Storage.EventCount > 0) and (FEventList.Count > 0);
  for I := 0 to FSubControls.Count - 1 do
    SubControls[I].LayoutChanged;
  if ACheckEventsCache and ((CurrentView.GetFirstVisibleDate < FEventList.SelStart) or
    (CurrentView.GetLastVisibleDate > FEventList.SelFinish)) then
  begin
    UpdateEventsCache(True);  
    CurrentView.LayoutChanged;
  end;
  UpdateScrollBars;
...
procedure TcxCustomScheduler.DoCanShowView(AView: TcxSchedulerCustomView; var Allow: Boolean);
begin
...
function TcxCustomScheduler.DoShowPopupMenu(AMenu: TComponent; X, Y: Integer): Boolean;
begin
  with CurrentView do
...
procedure TcxCustomScheduler.DoViewTypeChanged(ANewView: TcxSchedulerCustomView);
begin
...
function TcxCustomScheduler.GetControlFromPoint(const APoint: TPoint): TcxSchedulerSubControl;
var
  I: Integer;
begin
  Result := Background;
...
function TcxCustomScheduler.GetDesignHitTest(X, Y: Integer; Shift: TShiftState): Boolean;
begin
...
begin
  ...
  Result.Timezone := OptionsView.CurrentTimeZone;
  Result.TimezoneDaylightSaving := OptionsView.CurrentTimeZoneDaylightSaving;
...
function TcxCustomScheduler.GetEventHintText(AEvent: TcxSchedulerControlEvent): string;
begin
...
begin
  ...
  if CurrentView.IsShowResources then
    Result.Resources := TcxSchedulerControlEventAccess(AEvent).GetResourcesDisplayNames
  else
    Result.Resources := '';
  Result.TaskComplete := AEvent.TaskComplete;
  Result.Reminder := 'Keine Erinnerung';
...
function TcxCustomScheduler.GetNextView(AView: TcxSchedulerCustomView): TcxSchedulerCustomView;
begin
  Result := AView;
end;
...
procedure TcxCustomScheduler.InternalDeleteEvent(AEvent: TcxSchedulerControlEvent; AIgnoreRecurring: Boolean);
var
...
function TcxCustomScheduler.InternalMouseWheel(Shift: TShiftState; WheelDelta: Integer; MousePos: TPoint): Boolean;
begin
  Result := False; 
  if CurrentView <> nil then 
    Result := CurrentView.InternalMouseWheel(Shift, WheelDelta, MousePos); 
  if not Result then 
    Result := inherited InternalMouseWheel(Shift, WheelDelta, MousePos)
end;

function TcxCustomScheduler.IsDaysIntervalChanged(var AStart, AFinish: TDateTime): Boolean;
begin
  AStart := Min(CurrentView.FirstVisibleDate, DateNavigator.GetRealFirstDate) - CurrentView.GetVisibleDaysRange;
  AFinish := Max(CurrentView.GetLastAvailableDate + CurrentView.GetTimeIncrement * 2 + 7,      
...
procedure TcxCustomScheduler.KeyDown(var Key: Word; Shift: TShiftState);
begin
...
procedure TcxCustomScheduler.KeyUp(var Key: Word; Shift: TShiftState);
begin
...
procedure TcxCustomScheduler.LockUpdateChanged(ALocking: Boolean);
begin
end;

procedure TcxCustomScheduler.LookAndFeelChanged(Sender: TcxLookAndFeel; AChangedValues: TcxLookAndFeelValues);
var
  I: Integer;
begin
  Styles.ClearCache;
...
procedure TcxCustomScheduler.MouseDown(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var
  AShift: TShiftState;
begin
  AShift := Shift;
...
procedure TcxCustomScheduler.MouseMove(Shift: TShiftState; X, Y: Integer);
var
...
procedure TcxCustomScheduler.RemoveSubControl(AControl: TcxSchedulerSubControl);
begin
...
procedure TcxCustomScheduler.SetCurrentView(AView: TcxSchedulerCustomView);
begin
...
procedure TcxCustomScheduler.SubControlAdd(AControl: TcxSchedulerSubControl);
begin
  FSubControls.Add(AControl);
  LayoutChanged;
end;

procedure TcxCustomScheduler.SubControlRemove(AControl: TcxSchedulerSubControl);
begin
...
procedure TcxCustomScheduler.UnInitScrollbars;
var
  I: Integer;
begin
  inherited UnInitScrollbars;
  for I := 0 to FSubControls.Count - 1 do
    SubControls[I].UnInitScrollbars;
end;
...
procedure TcxCustomScheduler.UpdateEventsCache(ACheckDaysInterval: Boolean);
var
  AChanged: Boolean;
...
begin
  ...
  FEventList.ShowEventsWithoutResource := OptionsView.ShowEventsWithoutResource or (VisibleGroupingKind = gkNone);
...
begin
  ...
  begin
    ...
    begin
      FFirstVisibleResourceIndex := Max(0, ResourceNavigator.ResourceCount - OptionsView.ResourcesPerPage);
    end;
end;

procedure TcxCustomScheduler.ValidateSelection(ASelection: TcxSchedulerDateList);
begin
...
procedure TcxCustomScheduler.ViewVisibleChanged(AView: TcxSchedulerCustomView);
begin
  Exclude(FControlFlags, cfViewValid);
...
begin
  Result := inherited CanDrag(X, Y) and not IsDesigning and CaptureController.CanDrag(X, Y);
end;

procedure TcxCustomScheduler.DoEndDrag(Target: TObject; X, Y: Integer);
begin
...
procedure TcxCustomScheduler.DoStartDrag(var DragObject: TDragObject);
begin
...
procedure TcxCustomScheduler.DragAndDrop(const P: TPoint; var Accepted: Boolean);
begin
  inherited DragAndDrop(P, Accepted);
  CaptureController.DragAndDrop(P, Accepted);
end;

procedure TcxCustomScheduler.DragOver(Source: TObject; X, Y: Integer; State: TDragState; var Accept: Boolean);
var
...
procedure TcxCustomScheduler.EndDragAndDrop(Accepted: Boolean);
begin
...
function TcxCustomScheduler.StartDragAndDrop(const P: TPoint): Boolean;
begin
...
procedure TcxCustomScheduler.CreateWindowHandle(const Params: TCreateParams);
begin
  inherited CreateWindowHandle(Params);
  if cfInvalidLayout in ControlFlags then
    LayoutChanged;
end;
...
// IcxFormatControllerListener
procedure TcxCustomScheduler.DoStartOfWeekChanged(AOldStartOfWeek, ANewStartOfWeek: TDay);
var
  I, ADelta: Integer;
begin
...
begin
  ...
  if OptionsView.StartOfWeek = swSystem then
    DoStartOfWeekChanged(OptionsView.ActualStartOfWeek, TDay(DateTimeHelper.StartOfWeek))
  else
  begin
    for I := 0 to SubControlCount - 1 do
...
procedure TcxCustomScheduler.GetPropertyValue(const AName: string; var AValue: Variant);
var
  I: Integer;
begin
...
procedure TcxCustomScheduler.SetPropertyValue(const AName: string; const AValue: Variant);
var
  I: Integer;
  ADate: TDateTime;
begin
...
begin
  FUpdateTimeTimer := cxCreateTimer(UpdateTimeHandler, 60 * 1000);
end;
...
function TcxCustomScheduler.GetSelectedEvent(AIndex: Integer): TcxSchedulerControlEvent;
begin
...
function TcxCustomScheduler.GetSubControl(AIndex: Integer): TcxSchedulerSubControl;
begin
...
function TcxCustomScheduler.GetVisibleEvent(AIndex: Integer): TcxSchedulerControlEvent;
begin
  Result := EventList[AIndex];
end;

procedure TcxCustomScheduler.InitEventBySelection(AEvent: TcxSchedulerEvent; AllDay: Boolean;
...
procedure TcxCustomScheduler.SetCaptureControl(AValue: TcxSchedulerSubControl);
begin
...
procedure TcxCustomScheduler.SetContentPopupMenu(AValue: TcxSchedulerContentPopupMenu);
begin
  FContentPopupMenu.Assign(AValue);
end;

procedure TcxCustomScheduler.SetControlBox(AValue: TcxSchedulerControlBox);
begin
  FControlBox.Assign(AValue);
end;

procedure TcxCustomScheduler.SetDialogsLookAndFeel(AValue: TcxLookAndFeel);
begin
...
procedure TcxCustomScheduler.SetEventOperations(AValue: TcxSchedulerEventOperations);
begin
  FEventOperations.Assign(AValue);
end;

procedure TcxCustomScheduler.SetEventPopupMenu(AValue: TcxSchedulerEventPopupMenu);
begin
...
procedure TcxCustomScheduler.SetOptionsCustomize(AValue: TcxSchedulerOptionsCustomize);
begin
  FOptionsCustomize.Assign(AValue);
end;

procedure TcxCustomScheduler.SetOptionsView(AValue: TcxSchedulerOptionsView);
begin
  FOptionsView.Assign(AValue);
end;

procedure TcxCustomScheduler.SetStorage(AValue: TcxCustomSchedulerStorage);
begin
...
procedure TcxCustomScheduler.SetResourceNavigator(AValue: TcxSchedulerResourceNavigator);
begin
  FResourceNavigator.Assign(AValue);
end;

procedure TcxCustomScheduler.SetStyles(AValue: TcxSchedulerStyles);
begin
...
begin
  ...
  begin
    Self.CanShow := TcxSchedulerCustomView(Source).CanShow;
    Self.Active := TcxSchedulerCustomView(Source).Active;
  end
  else
    inherited Assign(Source);
end;
...
function TcxSchedulerCustomView.EventContentSelected(AEvent: TcxSchedulerControlEvent): Boolean;
begin
  Result := True;
end;
...
begin
  ...
  begin
    if IsResourceNavigatorAllowed and Scheduler.ResourceNavigator.NeedScrollBar and
      (Scheduler.ResourceNavigator.VisibleButtonCount > 0) then
    begin
...
function TcxSchedulerCustomView.GetEditStyle(AEvent: TcxSchedulerControlEvent): TcxCustomEditStyle;
begin
  Result := Scheduler.EditStyle;
end;

function TcxSchedulerCustomView.GetEditStyleViewParams(AEvent: TcxSchedulerControlEvent): TcxViewParams;
begin
  Result := Scheduler.Styles.GetEventContentParams(AEvent);
end;

function TcxSchedulerCustomView.GetEditProperties(AEvent: TcxSchedulerControlEvent): TcxCustomEditProperties;
begin
  Scheduler.DoGetEventEditProperties(AEvent, Result);
end;

function TcxSchedulerCustomView.GetEditWithSingleLineEditor(AEvent: TcxSchedulerControlEvent): Boolean;
begin
  Result := True;
end;
...
function TcxSchedulerCustomView.GetEventVisibility(AEvent: TcxSchedulerControlEvent): Boolean;
begin
  Result := False;
end;
...
function TcxSchedulerCustomView.GetLastAvailableDate: TDateTime;
begin
  Result := GetLastVisibleDate;
end;
...
function TcxSchedulerCustomView.GetSchedulerLookAndFeel(ADialogs: Boolean = False): TcxLookAndFeel;
begin
  if ADialogs then
...
procedure TcxSchedulerCustomView.InitEventBySelectedTime(AEvent: TcxSchedulerEvent; AllDay, ARecurrence, AInplaceEditing: Boolean);
var
...
function TcxSchedulerCustomView.InternalMouseWheel(Shift: TShiftState; WheelDelta: Integer; MousePos: TPoint): Boolean;
begin
  Result := False;
end;
...
function TcxSchedulerCustomView.IsWorkTime(AResourceItem: TcxSchedulerStorageResourceItem; const ADateTime: TDateTime): Boolean;
begin
  Result := Scheduler.DoIsWorkTime(AResourceItem, ADateTime);
end;

procedure TcxSchedulerCustomView.LockEventLayoutCalculating;
begin
  Inc(ViewInfo.FEventCellLayoutCalculateLockCount);
end;

procedure TcxSchedulerCustomView.UnlockEventLayoutCalculating;
begin
  ViewInfo.FEventCellLayoutCalculateLockCount := Max(0, ViewInfo.FEventCellLayoutCalculateLockCount - 1);
end;
...
procedure TcxSchedulerCustomView.ScrollSelectedDays(AForward: Boolean; ANeedDate: TDateTime; AIsByPage: Boolean);
begin
  Scheduler.DateNavigator.ScrollSelection(AForward, ANeedDate, AIsByPage);
end;

procedure TcxSchedulerCustomView.ScrollVisibleDays(AScrollUp: Boolean);
begin
end;
...
procedure TcxSchedulerCustomView.ValidateContentPopupMenuItems(var AItems: TcxSchedulerContentPopupMenuItems);
begin
end;

procedure TcxSchedulerCustomView.ValidateSelectionFinishTime(var ADateTime: TDateTime);
begin
end;
...
procedure TcxSchedulerCustomView.ShowHintOnScroll(const AHintText: string; AScrollBarKind: TScrollBarKind);
var
  R: TRect;
  P: TPoint;
begin
...
procedure TcxSchedulerCustomView.GetRangeControlRange(out AMin, AMax: TDateTime);
begin
...
function TcxSchedulerCustomViewViewInfo.DoGetEventDisplayText(AEvent: TcxSchedulerControlEvent): string;
begin
...
function TcxSchedulerCustomViewViewInfo.GetEventHint(AEvent: TcxSchedulerControlEvent): string;
begin
  Result := Scheduler.GetEventHintText(AEvent);
end;
...
begin
  ...
  FCachedDefaultParams := TDictionary<Integer, TcxViewParams>.Create;
  FCachedDataDefaultParams := TObjectDictionary<Integer, TDictionary<Integer, TcxViewParams>>.Create([doOwnsValues]);
end;

destructor TcxSchedulerStyles.Destroy;
begin
  FreeAndNil(FCachedDataDefaultParams);
  FreeAndNil(FCachedDefaultParams);
  inherited Destroy;
end;
...
function TcxSchedulerStyles.GetEventContentParams(AEvent: TcxSchedulerEvent): TcxViewParams;
var
  AStyle: TcxStyle;
begin
  AStyle := nil;
...
function TcxSchedulerStyles.IsEventStyleAssigned(AEvent: TcxSchedulerEvent): Boolean;
var
  AStyle: TcxStyle;
begin
...
function TcxSchedulerStyles.GetDayHeaderParams(const ADate: TDateTime): TcxViewParams;
var
  AStyle: TcxStyle;
begin
  AStyle := nil;
...
function TcxSchedulerStyles.GetResourceHeaderParams(AResource: TcxSchedulerStorageResourceItem): TcxViewParams;
var
  AStyle: TcxStyle;
begin
  AStyle := nil;
...
function TcxSchedulerStyles.GetSplitterParams(AKind: TcxSchedulerSplitterKind): TcxViewParams;
begin
...
var
  ...
  ASelected: Boolean;
begin
  if GetCachedDefaultViewParams(Index, AData, AParams) then
    Exit;
  AParams.Bitmap := nil;
  ...
  AddCachedDefaultViewParams(Index, AData, AParams);
end;
...
procedure TcxSchedulerStyles.AddCachedDefaultViewParams(Index: Integer; AData: TObject; const AParams: TcxViewParams);
var
  ACachedData: TDictionary<Integer, TcxViewParams>;
begin
  if not CanCacheViewParams(Index, AData) then
    Exit;
  if AData = nil then
    FCachedDefaultParams.Add(Index, AParams)
  else
  begin
    if not FCachedDataDefaultParams.TryGetValue(Index, ACachedData) then
    begin
      ACachedData := TDictionary<Integer, TcxViewParams>.Create;
      FCachedDataDefaultParams.Add(Index, ACachedData);
    end;
    ACachedData.Add(GetCachedDefaultViewParamsDataIndex(Index, AData), AParams);
  end;
end;

function TcxSchedulerStyles.CanCacheViewParams(Index: Integer; AData: TObject): Boolean;
var
  AEvent: TcxSchedulerControlEvent;
begin
  Result := (Index <> cxcsEvent) or (AData = nil);
  if not Result then
  begin
    AEvent := TcxSchedulerControlEvent(AData);
    Result := not EventContentSelected(AEvent);
  end;
end;

procedure TcxSchedulerStyles.ClearCache;
begin
  FCachedDefaultParams.Clear;
  FCachedDataDefaultParams.Clear;
end;

procedure TcxSchedulerStyles.ClearCache(AIndex: Integer);
begin
  FCachedDefaultParams.Remove(AIndex);
  FCachedDataDefaultParams.Remove(AIndex);
end;

function TcxSchedulerStyles.GetCachedDefaultViewParamsDataIndex(Index: Integer; AData: TObject): Integer;
begin
  if AData = nil then
    Exit(-1);
  case Index of
    cxcsEvent:
      if TcxSchedulerControlEvent(AData).Source = nil then
        Result := -1
      else
        Result := GetVariantHash(TcxSchedulerControlEvent(AData).ID);
  else
    Result := Integer(AData);
  end;
end;

function TcxSchedulerStyles.GetCachedDefaultViewParams(Index: Integer; AData: TObject; out AParams: TcxViewParams): Boolean;
var
  ACachedData: TDictionary<Integer, TcxViewParams>;
begin
  if not CanCacheViewParams(Index, AData) then
    Exit(False);
  if AData = nil then
    Result := FCachedDefaultParams.TryGetValue(Index, AParams)
  else
    Result := FCachedDataDefaultParams.TryGetValue(Index, ACachedData) and
      ACachedData.TryGetValue(GetCachedDefaultViewParamsDataIndex(Index, AData), AParams);
end;
...
procedure TcxSchedulerSplitterController.MouseDown(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
procedure TcxSchedulerSplitterController.MouseMove(Shift: TShiftState; X, Y: Integer);
var
  R: TRect;
begin
...
procedure TcxSchedulerSplitterController.MouseUp(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  if Scheduler.OptionsCustomize.ControlsSizing and (Button = mbLeft) then
  begin
...
procedure TcxSchedulerSplitterController.InvertRect(ACanvas: TcxCanvas; R: TRect);
begin
...
function TcxSchedulerSplitterController.GetHorzSizingRect(const P: TPoint): TRect;
var
...
function TcxSchedulerSplitterController.GetVertSizingRect(const P: TPoint): TRect;
var
  AStep, ANewPos: Integer;
begin
  AStep := GetSizingIncrement;
...
var
  W: Integer;
begin
  W := ((R.Right - R.Left - Splitter.Width) div GetMonthSize.cx) * GetMonthSize.cx + Splitter.Width;
...
function TcxSchedulerSplitter.AllowDesignHitTest(X, Y: Integer; AShift: TShiftState): Boolean;
begin
  Result := True;
end;
...
begin
  LookAndFeelPainter.DrawSchedulerSplitterBorder(Canvas, ClientRect, ViewParams, Kind = skHorizontal);
end;
...
const
  Cursors: array[TcxSchedulerSplitterKind] of TCursor = (crSchedulerVertSplit, crSchedulerHorzSplit);
begin
...
begin
  with Scheduler.EventOperations do
    Result := Scheduler.StorageActive and CanShowEventDialog and Creating and DialogEditing and not GetResourceReadOnly;
end;
...
function TcxSchedulerViewController.CanEditEvent(AEvent: TcxSchedulerControlEvent; AInplace: Boolean): Boolean;
begin
  with Scheduler.EventOperations do
  begin
    if AInplace then
...
begin
  Result := IsEditing and (EditController.Event = AEvent) and (EditController.FEditResource = AResource);
end;
...
begin
  if AMakeVisible then
    View.MakeEventVisible(AEvent, ADate, nil);
  Scheduler.EventList.Selection.Add(AEvent, []);
end;

procedure TcxSchedulerViewController.BeforeMouseDown(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited BeforeMouseDown(Button, Shift, X, Y);
  StopEditShowingTimer;
  Scheduler.HintController.Hide;
  if not CanProcessMouseMove then
    Exit;
  HitTest.Recalculate;
...
procedure TcxSchedulerViewController.CheckScrolling(const APos: TPoint);
begin
end;

procedure TcxSchedulerViewController.CheckScrollOnDragOver(const P: TPoint; State: TDragState);
begin
  if State <> dsDragLeave then
    CheckScrolling(P)
  else
...
begin
  if (Scheduler.DragAndDropState = ddsInProcess) and (Scheduler.DragAndDropObject is TcxSchedulerDragAndDropObject) then
  begin
...
procedure TcxSchedulerViewController.DoSchedulerDragOver(const P: TPoint; AState: TDragState; var AAccept: Boolean);
begin
...
procedure TcxSchedulerViewController.KeyDown(var Key: Word; Shift: TShiftState);
begin
  ...
  begin
    ...
    begin
      ...
      try
        UnselectEvents;
        View.LockEventLayoutCalculating;
        Navigation.DoKeyDown(Key, Shift);
      finally
        Scheduler.EndUpdate;
        View.UnlockEventLayoutCalculating;
        Scheduler.Update;
      end;
    end;
    case Key of
...
begin
  ...
  begin
    ...
    if (Key = dxVKReturn) or IsEditStartChar(Key) then
    begin
      if Key = dxVKReturn then
      begin
...
procedure TcxSchedulerViewController.MouseDown(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var
  AEvent: TcxSchedulerControlEvent;
...
procedure TcxSchedulerViewController.MouseUp(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited MouseUp(Button, Shift, X, Y);
...
begin
  if Scheduler.EventList.Count = 0 then
    Exit;
  ASelectedIndex := -1;
  for I := 0 to Scheduler.EventList.Count - 1 do
    if Scheduler.EventList[I].Selected then
      ASelectedIndex := I;
  if (ASelectedIndex >= 0) and (Scheduler.TabOrdersList.Count > 0) then
    ASelectedIndex := Scheduler.TabOrdersList.IndexOf(Scheduler.EventList[ASelectedIndex]);
  GetNextSelectedIndex(ASelectedIndex);
  if ASelectedIndex < -1 then
    ASelectedIndex := Scheduler.TabOrdersList.Count - 1;
  while (ASelectedIndex < Scheduler.TabOrdersList.Count) and (ASelectedIndex >= 0) and
      not Scheduler.CurrentView.GetEventVisibility(TcxSchedulerControlEvent(Scheduler.TabOrdersList[ASelectedIndex])) do
    GetNextSelectedIndex(ASelectedIndex);
  if (ASelectedIndex < Scheduler.EventList.Count) and (ASelectedIndex >= 0) then
    SelectSingleEvent(TcxSchedulerControlEvent(Scheduler.TabOrdersList[ASelectedIndex]), NullDate)
  else
    UnselectEvents;
  Scheduler.CurrentView.Refresh;
end;
...
begin
  Result := (DragKind in [edkResizeStart, edkResizeEnd]) and (DragEvent <> nil) and not DragEvent.OpenedInEditor and
    Scheduler.DoBeforeSizingEvent(DragEvent, P.X, P.Y);
end;

procedure TcxSchedulerViewController.SyncEventSelection(AEvent: TcxSchedulerControlEvent);
var
  AResource: TcxSchedulerStorageResourceItem;
begin
...
var
  ...
  ACode: TScrollCode;
begin
  APoint := cxPointOffset(Scheduler.ScreenToClient(GetMouseCursorPos), -View.Left, -View.Top);
  if not PtInRect(View.ClientRect, APoint) then
    Exit;
...
function TcxSchedulerViewController.PtInArea(const ARect: TRect; const P: TPoint; IsUpArea: Boolean): Boolean;
var
  AHorz: Boolean;
begin
  ...
  begin
    ...
    if IsUpArea then
      Result := (AHorz and (P.X < ARect.Left)) or (not AHorz and (P.Y < ARect.Top))
    else
      Result := (AHorz and (P.X > ARect.Right)) or (not AHorz and (P.Y > ARect.Bottom))
  end;
end;
...
function TcxSchedulerViewController.GetNavigatorTimer: TcxTimer;
begin
...
procedure TcxSchedulerViewController.ShowEventEditor(AEvent: TcxSchedulerControlEvent);
begin
  StopEditShowingTimer;
  if CanShowEventDialog then
...
procedure TcxSchedulerViewController.StartEditShowingTimer(AEvent: TcxSchedulerControlEvent);
begin
  StopEditShowingTimer;
...
procedure TcxEventSizingHelper.DragOver(const P: TPoint; State: TDragState; var Accepted: Boolean);
begin
...
begin
  Result := HitTest.HitAtTime and (not HitTest.HitAtResource or (FStartResource = HitTest.Resource));
end;
...
procedure TcxSchedulerDragAndDropObject.DragAndDrop(const P: TPoint; var Accepted: Boolean);
var
  AP: TPoint;
begin
...
function TcxSchedulerDragAndDropObject.GetDragAndDropCursor(Accepted: Boolean): TCursor;
begin
  if Assigned(FSizingHelper) then
...
constructor TcxSchedulerOptionsCustomize.Create(AOwner: TcxCustomScheduler);
begin
  FScheduler := AOwner;
...
begin
  TcxSchedulerResourceViewInfoAccess(
   (FOwner.Scheduler.CurrentView.ViewInfo as TcxSchedulerCustomResourceViewViewInfo)).ResourceHeadersChanged;
  FOwner.Changed;
end;
...
procedure TcxSchedulerResourceHeaders.SetImagePosition(AValue: TcxSchedulerHeaderImagePosition);
begin
...
constructor TcxSchedulerOptionsView.Create(AOwner: TcxCustomScheduler);
begin
  inherited Create;
  FScheduler := AOwner;
...
begin
  FreeAndNil(FResourceHeaders);
  inherited Destroy;
end;

procedure TcxSchedulerOptionsView.Assign(Source: TPersistent);
var
  AItem: Integer;
...
begin
  ...
  if Result then
  begin
    ATime := DateTimeHelper.RoundTime(dxTimeOf(ADateTime));
    if AWorkStart < AWorkFinish then
      Result := ((ATime >= AWorkStart) and (ATime < AWorkFinish))
    else
      Result := ((ATime >= AWorkStart) or (ATime < AWorkFinish))
  end;
end;
...
function TcxSchedulerOptionsView.GetTimeZone(AIndex: Integer): Integer;
begin
...
function TcxSchedulerOptionsView.GetTimeZoneLabel(AIndex: Integer): string;
begin
  Result := FTimeZoneLabels[AIndex];
end;

function TcxSchedulerOptionsView.IsTimeZoneLabelStored(AIndex: Integer): Boolean;
begin
  Result := FTimeZoneLabels[AIndex] <> '';
end;
...
procedure TcxSchedulerOptionsView.SetGroupingKind(AValue: TcxSchedulerGroupingKind);
begin
...
procedure TcxSchedulerOptionsView.SetGroupSeparatorWidth(AValue: Integer);
begin
...
procedure TcxSchedulerOptionsView.SetResourceHeaders(AValue: TcxSchedulerResourceHeaders);
begin
...
procedure TcxSchedulerOptionsView.SetResourcesPerPage(AValue: Integer);
begin
  AValue := Max(AValue, 0);
...
procedure TcxSchedulerOptionsView.SetShowEventsWithoutResource(AValue: Boolean);
begin
...
procedure TcxSchedulerOptionsView.SetTimeZone(AIndex, AValue: Integer);
begin
...
procedure TcxSchedulerOptionsView.SetTimeZoneLabel(AIndex: Integer; const AValue: string);
begin
...
procedure TcxSchedulerOptionsView.SetViewPosition(AValue: TcxSchedulerViewPosition);
begin
...
procedure TcxSchedulerEditController.Activate(AEvent: TcxSchedulerControlEvent);
begin
  if InitEdit(AEvent) then
    FEdit.Activate(FEditData);
end;

procedure TcxSchedulerEditController.Activate(AEvent: TcxSchedulerControlEvent; const APos: TPoint; AShift: TShiftState);
begin
  if InitEdit(AEvent) then
    FEdit.ActivateByMouse(AShift, APos.X, APos.Y, FEditData);
end;

procedure TcxSchedulerEditController.Activate(AEvent: TcxSchedulerControlEvent; Key: Char);
begin
  if InitEdit(AEvent) then
  ...
  try
    ...
    begin
      ...
      try
        ...
        begin
          if not (cfInvalidLayout in Scheduler.ControlFlags) then
          begin 
            Scheduler.CurrentView.LockEventLayoutCalculating;
            try
              Scheduler.CurrentView.Refresh;
            finally
              Scheduler.CurrentView.UnlockEventLayoutCalculating;
            end
          end
          else
            Scheduler.CurrentView.Refresh;
...
begin
  ...
  R := cxRectOffset(View.GetEditRectForEvent(Event, ADate, AResource), View.Bounds.TopLeft);
  Result := not cxRectIsEmpty(R);
end;

procedure TcxSchedulerEditController.EditAfterKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TcxSchedulerEditController.EditKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);

   function IsExistEventCancelChanges: Boolean;
   begin
     Result := not FIsNewEvent and (Key = VK_ESCAPE);
   end;

begin
  if IsKeyForControl(Key, Shift) then
  begin
    if IsExistEventCancelChanges then
      View.LockEventLayoutCalculating;
...
procedure TcxSchedulerEditController.EditKeyPress(Sender: TObject; var Key: Char);
begin
  if Assigned(Scheduler.OnKeyPress) then
    Scheduler.OnKeyPress(Scheduler, Key);
end;

procedure TcxSchedulerEditController.EditKeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
{  Controller.SelectSingleEvent(AEvent, NullDate, False);     }
  if not (Scheduler.DoBeforeEditing(AEvent, True) and GetEditRect(R, FEditDate, FEditResource, True)) then
    Exit;
...
function TcxSchedulerEditController.IsKeyForControl(var AKey: Word; Shift: TShiftState): Boolean;
begin
...
begin
  ...
  if AVisible then // T1250876
  begin
    FEdit.InternalProperties.Alignment.Vert := VertAlignments[View.GetEditWithSingleLineEditor(Event)];
    FEdit.Parent := Scheduler;
    FEdit.BoundsRect := R;
    FEdit.EditValue := FEvent.Caption;
    FEdit.OnAfterKeyDown := EditAfterKeyDown;
    FEdit.OnExit := EditExit;
    FEdit.OnKeyDown := EditKeyDown;
    FEdit.OnKeyPress := EditKeyPress;
    FEdit.OnKeyUp := EditKeyUp;
    FEdit.OnPostEditValue := EditPostEditValue;
    FEdit.Style.Init(View.GetEditStyleViewParams(Event));
    FEdit.Visible := True;
...
constructor TcxSchedulerViewNavigation.Create(AView: TcxSchedulerCustomView);
begin
  FView := AView;
end;
...
procedure TcxSchedulerViewNavigation.ReplaceSelParams(const ASelStart, ASelFinish: TDateTime);
begin
...
procedure TcxSchedulerViewNavigation.ReplaceSelParams(AResource: TcxSchedulerStorageResourceItem);
begin
...
begin
  ...
  begin
    if not AGoForward then
      ...
      AResource := VisibleResources[ResourceNavigator.ResourcesPerPage + ResourceNavigator.FirstVisibleResourceIndex - 1];
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      ResourceNavigator.FirstVisibleResourceIndex := VisibleResourceCount - ResourceNavigator.ResourcesPerPage;
      Result := True;
    end;
end;

procedure TcxSchedulerViewNavigation.SetSelAnchor(const Anchor: TDateTime; AShift: TShiftState);
begin
...
procedure TcxSchedulerViewNavigation.DoKeyDown(var AKey: Word; AShift: TShiftState);
begin
  Scheduler.BeginUpdate;
  try
...
function TcxSchedulerViewNavigation.IsKeyNavigation(var AKey: Word; AShift: TShiftState): Boolean;
begin
...
begin
  Result := dxTimeOf(Abs(Scheduler.FSelStart - Scheduler.FSelFinish)) <= View.GetTimeIncrement;
end;
...
procedure TcxSchedulerViewNavigation.ReplaceDate(ADate: TDateTime; AResource: TcxSchedulerStorageResourceItem);
begin
...
function TcxSchedulerViewNavigation.GetVisibleResource(AIndex: Integer): TcxSchedulerStorageResourceItem;
begin
  if Scheduler.StorageValid then
...
procedure TcxSchedulerNavigatorButton.Draw(APainter: TcxCustomLookAndFeelPainter; ACanvas: TcxCanvas);
var
  AGlyphRect: TRect;
...
function TcxSchedulerNavigatorButton.GetState(ACanDisabled: Boolean = True): TcxButtonState;
var
...
begin
  Result := (Command >= cxSchedulerFirstButton) and (Command <= cxSchedulerShowFewerResourcesButton);
end;
...
procedure TcxSchedulerNavigatorCustomButtons.Update(Item: TCollectionItem);
begin
  if (Scheduler <> nil) and not Scheduler.IsLocked then
    Scheduler.LayoutChanged;
end;

function TcxSchedulerNavigatorCustomButtons.GetItem(AIndex: Integer): TcxSchedulerNavigatorCustomButton;
begin
...
procedure TcxSchedulerNavigatorCustomButtons.SetItem(AIndex: Integer; AValue: TcxSchedulerNavigatorCustomButton);
begin
...
constructor TcxSchedulerNavigatorButtons.Create(AOwner: TcxSchedulerResourceNavigator);
begin
  inherited Create;
  FOwner := AOwner;
  FButtons := TcxSchedulerNavigatorCustomButtons.CreateEx(AOwner, TcxSchedulerNavigatorButton);
...
function TcxSchedulerNavigatorButtons.AddButton(ACommand: Integer; AVisible: Boolean = True): TcxSchedulerNavigatorButton;
begin
...
function TcxSchedulerNavigatorButtons.GetButtonByIndex(AIndex: Integer): TcxSchedulerNavigatorButton;
var
  I: Integer;
begin
  Result := nil;
...
procedure TcxSchedulerNavigatorButtons.SetButtonByIndex(AIndex: Integer; AValue: TcxSchedulerNavigatorButton);
begin
...
procedure TcxSchedulerResourceNavigator.ButtonClickHandler(AButton: TcxSchedulerNavigatorButton);
var
  APrevIndex: Integer;
begin
...
begin
  ...
  begin
    FEmptyAreaBounds := cxRectSetBottom(R, R.Bottom, Scheduler.HScrollBar.Height);
    R.Top := FEmptyAreaBounds.Top;
  ...
  begin
    ...
    if Scheduler.UseRightToLeftScrollBar then
      R := TdxRightToLeftLayoutConverter.ConvertRect(R, Scheduler.CurrentView.Bounds);
    FEmptyAreaBounds := cxRectSetXPos(FEmptyAreaBounds, R.Left, R.Right);
  end;
  Bounds := R;
end;
...
procedure TcxSchedulerResourceNavigator.Click(Sender: TcxSchedulerNavigatorButton);
begin
...
function TcxSchedulerResourceNavigator.DoCustomDrawButton(AButton: TcxSchedulerNavigatorButton): Boolean;
begin
  Result := False;
...
function TcxSchedulerResourceNavigator.DoOnClick(Sender: TcxSchedulerNavigatorButton): Boolean;
begin
  Result := False;
...
procedure TcxSchedulerResourceNavigator.InvalidateButton(AButton: TcxSchedulerNavigatorButton);
begin
  if AButton.Visible and (AButton.GetState <> AButton.State) then
    InvalidateRect(AButton.Bounds);
end;

procedure TcxSchedulerResourceNavigator.Paint;
begin
  if Visible then
    Canvas.FillRect(EmptyAreaBounds, LookAndFeelPainter.DefaultSchedulerNavigatorColor);
  inherited Paint;
end;

procedure TcxSchedulerResourceNavigator.Scroll(AScrollCode: TScrollCode; var AScrollPos: Integer);
var
...
procedure TcxSchedulerResourceNavigator.UpdateViewData;
begin
...
procedure TcxSchedulerResourceNavigator.SetCustomButtons(Value: TcxSchedulerNavigatorCustomButtons);
begin
...
procedure TcxSchedulerResourceNavigator.SetButtons(Value: TcxSchedulerNavigatorButtons);
begin
...
procedure TcxSchedulerResourceNavigator.SetVisibility(AValue: TcxSchedulerNavigatorVisibilityMode);
begin
...
function TcxSchedulerControlBox.HasAsParent(AValue: TControl): Boolean;
var
  AParent: TWinControl;
begin
  Result := False;
...
procedure TcxSchedulerControlBox.SetControl(AValue: TControl);
begin
