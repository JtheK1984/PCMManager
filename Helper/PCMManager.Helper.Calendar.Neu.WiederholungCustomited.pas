unit PCMManager.Helper.Calendar.Neu.WiederholungCustomited;
...
type
  TcxSchedulerRecurrenceEventEditorFormCus = class(TcxSchedulerRecurrenceEventEditorForm)
...
var
  cxSchedulerRecurrenceEventEditorForm: TcxSchedulerRecurrenceEventEditorForm;
...
procedure TcxSchedulerRecurrenceEventEditorFormCus.SelectDaysOfWeek(ADays: TDays);
...
procedure TcxSchedulerRecurrenceEventEditorFormCus.FormShow(Sender: TObject);
