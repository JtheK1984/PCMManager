...
uses
  ...
  Data.Bind.ObjectScope, dxShellDialogs,PCM.Functions;
...
//    olvarNameSpace.Logon('Outlook','NhJh2084+2',True,False);
  ...
  try
    ...
    begin
      ...
      if SUMMARY = 'Daily' then ShowMessage('2');
...
begin
  try
    dm_PCM.qry_work.sql.text:= 'Select Farbe, Schriftfarbe from manager_stundenplan_config';
    dm_PCM.qry_work.open;
