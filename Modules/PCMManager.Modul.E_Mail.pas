...
begin
  ...
  stbr_user.Panels[2].text := '‹bermittlung abgeschlossen      ';
...
begin
  ...
  begin
    ...
    begin
      ...
      stbr_user.Panels.Items[2].Text:=  Format( '‹bermittlungsstatus %d', [Round(iAnzahlCount / iCount * 100)]) + '%      ';
      stbr_user.Panels.Items[2].Text:=  '‹bermittlungsstatus: ' + IntToStr(i+1) + ' von ' + IntToStr(iCount) + ' Mails verarbeitet';
//
      Application.ProcessMessages;
